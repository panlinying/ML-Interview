"""
ML Interview Preparation - Note Generator
...
def main():
    """CLI entry point for generating Obsidian notes."""
    parser = argparse.ArgumentParser(
        description="Generate Obsidian daily notes from a markdown study plan.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  ml-interview plan.md
  ml-interview plan.md --out ./vault --days 5
  ml-interview plan.md --start 2026-01-12 --days 7
        """
    )
